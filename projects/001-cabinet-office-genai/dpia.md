...
| **Project Owner** | Cabinet Office Chief Technology Officer |
...
**Generated by**: ArcKit v1.0 `/arckit.dpia` command
**Generation Date**: 2025-11-04
**Template Version**: dpia-template.md (ICO-aligned, UK GDPR Article 35)
**Project ID**: 001 (Cabinet Office GenAI Platform)
